...
class MarioCudaAgent:
    def __init__(self):
        ...
        self.agent_parameters["n_episodes"] = 999999999 # 800

        # How should the agent train? using the GPU?
        self.agent_parameters["gpu"] = 1 # 0
        ...
        self.agent_parameters['experience_episodes'] = 999999999
        self.agent_parameters['memory_size'] = 100000 # Need to address memory issues to use 1000000
        ...
        self.agent_parameters['reward_max_x_change'] = 24 # Prevent huge rewards for x-position changes when Mario enters/exits pipes, etc.
        ...
        self.agent_parameters['log_dir'] = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))))
