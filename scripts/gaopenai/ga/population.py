...
from scripts.gaopenai.ga.individual import statistics
from scripts.gaopenai.util.timing import timing
...
class Population:
    ...
    def run(self, env, run_generation: Callable, verbose=False, log=False, output_folder=None, save_as_pytorch=False):
        ...
        for i in range(self.max_generation):
            [p.calculate_fitness(env, self.p_episodes) for p in self.old_population]
